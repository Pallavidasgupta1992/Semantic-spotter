...
1. The policy documents can be found as (./Policy+Documents) in the folder.
...
- Python 3.7+
- langchain 0.3.13
- Please ensure that you add your OpenAI API key to the .ipynb code.I had manually added it in Line 47 and run the program.

## 8. Running

- Clone the github repository
  ```shell
  $ git clone https://github.com/Pallavidasgupta1992/Semantic-spotter.git
  ```
- Open
  the [notebook](https://github.com/Pallavidasgupta1992/Semantic-spotter/blob/main/semantic-spotter-langchain-notebook.ipynb)
  in jupyter and run all cells, but remember to add your OpenAI API Key.